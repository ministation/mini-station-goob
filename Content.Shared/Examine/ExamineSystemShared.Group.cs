...
namespace Content.Shared.Examine
{
    public abstract partial class ExamineSystemShared : EntitySystem
    {
        ...
        {
            AddDetailedExamineVerb(verbsEvent, component, entries, verbText, new SpriteSpecifier.Texture(new ResPath(iconTexture)), hoverMessage, isHoverExamine);
        }
        ...
        public void AddHoverExamineVerb(GetVerbsEvent<ExamineVerb> verbsEvent, Component component, string verbText, string hoverMessage, SpriteSpecifier icon)
        {
            AddDetailedExamineVerb(verbsEvent, component, FormattedMessage.Empty, verbText, icon, hoverMessage, true);
        }
    }
}