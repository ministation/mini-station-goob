...
{
    public Dictionary<string, DeployableTurretState> TurretStateByAddress;

    public DeployableTurretControllerBoundInterfaceState(Dictionary<string, DeployableTurretState> turretStateByAddress)
    {
