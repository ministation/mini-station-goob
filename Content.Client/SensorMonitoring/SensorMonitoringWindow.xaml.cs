...
public sealed partial class SensorMonitoringWindow : FancyWindow, IComputerWindow<ConsoleUIState>
{
    ...
    private void Update()
    {
        ...
        var headingFont = _cache.GetStack("Bold", 12);
        var regularFont = _cache.GetStack("Regular", 12);
        var weakFont = _cache.GetStack("Regular", 11);
        var monoFont = _cache.GetStack("Mono-Regular", 12);
                ...
                Asdf.AddChild(new BoxContainer
                {
                    ...
                    Children =
                    {
                        new Label
                        {
                            ...
                            FontOverride = monoFont,
                        },
                        new Label { Text = FormatValue(stream.Unit, lastSample.Value), FontOverride = regularFont }
                    }
                });
