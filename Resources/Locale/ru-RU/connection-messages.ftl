...
ban-banned-2 = Вы были забанены по причине: "{ $reason }"
...
whitelist-manual = Сервер в закрытом наборе. Доступ только у одобренных игроков. Заполните анкету в Discord Оазиса и дождитесь решения администрации.
...
whitelist-fail-prefix = Закрытый набор: { $msg }
