...
antag-token-window-tooltip-ghost = Потратить монеты и зарезервировать эту гост-роль только за собой.
antag-token-window-tooltip-deposit = Потратить монеты и поставить роль в очередь на следующий подходящий раунд.
antag-token-window-tooltip-free = Использовать бесплатный жетон на конкретную роль вместо билетов.
...
antag-store-role-agent-description = Классический предатель, выбирается заранее из лобби. Доступен в лёгком, среднем, выживании, хаосе и предателях.

antag-store-role-ninja-name = Ниндзя
antag-store-role-ninja-description = Вызов события ниндзя. Роль-призрак достанется только вам. Доступно в среднем и выживании.

antag-store-role-dragon-name = Дракон
antag-store-role-dragon-description = Вызов события дракона. Роль-призрак достанется только вам. Только выживание.

antag-store-role-abductor-name = Абдуктор
antag-store-role-abductor-description = Вызов события абдуктора. Одиночная роль для похищений. Доступен в любом режиме.

antag-store-role-initial-infected-name = Нулевой заражённый
antag-store-role-initial-infected-description = Очередь на нулевого заражённого. Выбирается заранее в лобби. Доступен в зомби, среднем и выживании.
...
antag-store-role-devil-description = Очередь на дьявола. Выбирается заранее в лобби. Доступен в лёгком и выживании.
...
antag-store-role-wizard-description = Покупка мага через отдельное событие посреди раунда. Только выживание.
...
antag-store-role-changeling-description = Очередь на генокрада. Выбирается заранее в лобби. Выживание и режим генокрадов.

antag-store-role-heretic-name = Еретик
antag-store-role-heretic-description = Очередь на еретика. Выбирается заранее в лобби. Выживание и еретики.

antag-store-role-shadowling-name = Шедоулинг
antag-store-role-shadowling-description = Очередь на шедоулинга. Выбирается заранее в лобби. Шедоулинги и выживание.
...
antag-tokens-popup-deposit-refunded-queue-cap = Очередь переполнена при текущем онлайне. Билеты возвращены — раньше в очередь встали другие игроки.
...
antag-tokens-error-round-limit = Один антагонист в раунд
