...
loadout-group-roboticist-envirohelm = Робототехник, экошлем
loadout-group-roboticist-envirosuit = Робототехник, экокостюм
loadout-group-roboticist-envirogloves = Робототехник, экоперчатки
