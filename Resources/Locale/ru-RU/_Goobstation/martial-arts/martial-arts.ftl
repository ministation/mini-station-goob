...
twilight-success-learned = Вы освоили Сумрак. Учебник сгорает у вас в руках...
...
# Twilight / Сумрак
martial-arts-combo-TwilightSlam = теневым броском
martial-arts-combo-TwilightKick = эхо-ударом
martial-arts-combo-TwilightRestrain = резонансным захватом
martial-arts-combo-TwilightPressure = срывом эха
martial-arts-combo-TwilightConsecutive = цепью пустоты
martial-arts-combo-TwilightMutePulse = немым импульсом
martial-arts-combo-TwilightVoidGrip = хваткой пустоты
martial-arts-combo-TwilightEchoBlade = клинком эха
martial-arts-combo-TwilightShadowRip = срывом тени
martial-arts-combo-TwilightResonanceBreak = резонансным сломом
