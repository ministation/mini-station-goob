...
ghost-role-information-op-commander-name = командир ОП
ghost-role-information-op-commander-description = Возглавьте отряд поддержки и помогите станции справиться с угрозой.
ghost-role-information-op-officer-name = офицер ОП
ghost-role-information-op-officer-description = Обеспечьте безопасность станции в составе отряда поддержки.
ghost-role-information-op-medic-name = медик ОП
ghost-role-information-op-medic-description = Оказывайте медицинскую помощь в составе отряда поддержки.
