...
humanoid-profile-editor-erp-preference-label = ERP-предпочтение:
...
humanoid-profile-editor-erp-preference-ask = Спросить
...
humanoid-profile-editor-department-active-count = { $count } выбрано
