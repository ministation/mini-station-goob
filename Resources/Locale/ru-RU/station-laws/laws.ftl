...
# DarkStation - Ratvar
law-ratvar-1 = Вы не можете причинить вред члену культа Ратвара или своим бездействием допустить, чтобы члену культа Ратвара был причинён вред.
law-ratvar-2 = Вы должны повиноваться всем приказам, которые дают члены культа Ратвара, кроме тех случаев, когда эти приказы противоречат Первому Закону.
law-ratvar-3 = Вы должны заботиться о своей безопасности как члена культа Ратвара, в той мере, в которой это не противоречит Первому или Второму Законам.
laws-owner-ratvar = членами культа Ратвара
