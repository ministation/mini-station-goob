...
ui-options-interface-accent-red = R UI:
ui-options-interface-accent-green = G UI:
ui-options-interface-accent-blue = B UI:
...
ui-options-function-open-a-language-menu = Открыть меню языков
...
ui-options-function-action-bar-previous-page = Предыдущая страница хотбара
ui-options-function-action-bar-next-page = Следующая страница хотбара
...
ui-options-foot-walk-animation = Анимация ходьбы
