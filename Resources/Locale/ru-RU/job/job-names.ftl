...
job-name-centcom-assistant = стажер ЦК
...
job-name-ertleader-amber = лидер ОБР (синий)
job-name-ertleader-red = лидер ОБР (красный)
job-name-ertleader-gamma = лидер ОБР (гамма)
job-name-ertsecurity-amber = офицер ОБР (синий)
job-name-ertsecurity-red = офицер ОБР (красный)
job-name-ertsecurity-gamma = офицер ОБР (гамма)
job-name-ertmedic-amber = медик ОБР (синий)
job-name-ertmedic-red = медик ОБР (красный)
job-name-ertmedic-gamma = медик ОБР (гамма)
job-name-ertjuggernaut = джаггернаут ОБР
job-name-ertengineer-amber = инженер ОБР (синий)
job-name-ertengineer-red = инженер ОБР (красный)
job-name-ertengineer-gamma = инженер ОБР (гамма)
job-name-ertjanitor-amber = уборщик ОБР (синий)
