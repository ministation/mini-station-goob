...
ent-BorgModuleSecurityStandard = стандартный СБ модуль борга
    .desc = Стандартный охранный модуль для патрулирования и задержания нарушителей.
ent-BorgModuleSecurityAdvanced = продвинутый СБ модуль борга
    .desc = Продвинутый охранный модуль, оснащённый самозаряжающимся пистолетом.
...
ent-XenoborgModuleDoorControl = модуль ксеноборга для управления шлюзами
