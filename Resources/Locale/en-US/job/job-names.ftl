...
job-name-centcom-assistant = CentComm Intern
...
job-name-ertleader-amber = Support Squad Leader
job-name-ertleader-red = ERT Leader (Red)
job-name-ertleader-gamma = ERT Leader (Gamma)
job-name-ertsecurity-amber = Support Squad Security
job-name-ertsecurity-red = ERT Security (Red)
job-name-ertsecurity-gamma = ERT Security (Gamma)
job-name-ertmedic-amber = Support Squad Medic
job-name-ertmedic-red = ERT Medic (Red)
job-name-ertmedic-gamma = ERT Medic (Gamma)
job-name-ertjuggernaut = ERT Juggernaut
job-name-ertengineer-amber = Support Squad Engineer
job-name-ertengineer-red = ERT Engineer (Red)
job-name-ertengineer-gamma = ERT Engineer (Gamma)
job-name-ertjanitor-amber = Support Squad Janitor
job-name-ertjanitor-red = ERT Janitor (Red)
job-name-ertjanitor-gamma = ERT Janitor (Gamma)
