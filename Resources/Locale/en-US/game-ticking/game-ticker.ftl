...
game-ticker-observer-spawn-failed = Could not spawn you as an observer (no valid spawn point). Try rejoining or ask an admin.
game-ticker-get-info-text = Waiting for you on [color=#8B00FF]Oasis![/color]
                            The current round is: [color=white]#{$roundId}[/color]
                            The current player count is: [color=white]{$playerCount}[/color]
                            The current map is: [color=white]{$mapName}[/color]
                            The current game mode is: [color=white]{$gmTitle}[/color]
                            >[color=yellow]{$desc}[/color]
game-ticker-get-info-preround-text = Waiting for you on [color=#8B00FF]Oasis![/color]
                            The current round is: [color=white]#{$roundId}[/color]
