...
ent-BorgModuleSecurityStandard = security cyborg module
    .desc = A standard security module for patrol and detention tasks.
ent-BorgModuleSecurityAdvanced = advanced security cyborg module
    .desc = An advanced security module equipped with a self-charging sidearm.
