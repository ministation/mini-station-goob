...
public sealed partial class SupermatterComponent : Component
{
    ...
    public readonly Dictionary<Gas, (float TransmitModifier, float HeatPenalty, float PowerMixRatio, float AngerValue)> GasDataFields = new()
    {
        ...
        [Gas.Hydrogen] = (TransmitModifier: 15f, HeatPenalty: 5f, PowerMixRatio: 1f, AngerValue: 1f),
        [Gas.HyperNoblium] = (TransmitModifier: 0f, HeatPenalty: 2f, PowerMixRatio: 1f, AngerValue: 1f),
        [Gas.ProtoNitrate] = (TransmitModifier: 0f, HeatPenalty: 0.1f, PowerMixRatio: 2f, AngerValue: 1f),
        [Gas.Zauker] = (TransmitModifier: 2f, HeatPenalty: 2f, PowerMixRatio: 1f, AngerValue: 1f),
        [Gas.Halon] = (TransmitModifier: 0f, HeatPenalty: 0f, PowerMixRatio: 0f, AngerValue: 0f),
        [Gas.Helium] = (TransmitModifier: 0f, HeatPenalty: 0f, PowerMixRatio: 0f, AngerValue: 0f),
        [Gas.AntiNoblium] = (TransmitModifier: .1f, HeatPenalty: .01f, PowerMixRatio: 1f, AngerValue: 1f),    };
