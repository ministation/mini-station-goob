...
using Content.Goobstation.Shared.Radio; // Mini/Goob - job icons in local chat
...
using Content.Shared.StatusIcon; // Mini/Goob - job icons in local chat
...
public sealed partial class ChatSystem : SharedChatSystem
{
    ...
    [Dependency] private readonly RadioJobIconSystem _radioIconSystem = default!; // Mini/Goob - job icons in local chat
        ...
        )
    {
        ...
        // Mini/Goob - Job icons for local chat
        ...
        )
    {
        ...
        foreach (var (session, data) in GetRecipients(source, WhisperMuffledRange))
        {
            ...
            else
            {
                ...
                result = ObfuscateMessageReadability(perceivedMessage);
                wrappedMessage = WrapWhisperMessage(source, "chat-manager-entity-whisper-unknown-wrap-message", string.Empty, result, language, colorOverride, jobIcon, jobName);
            }
    ...
    /// </summary>
    public string WrapPublicMessage(EntityUid source, string name, string message, LanguagePrototype? language = null, Color? colorOverride = null, ProtoId<JobIconPrototype>? jobIcon = null, string? jobName = null)
    {
