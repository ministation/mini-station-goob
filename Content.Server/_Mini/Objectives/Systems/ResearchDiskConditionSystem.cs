using Content.Server._Mini.Objectives.Components;
using Content.Server._Mini.Research.Components;
...
namespace Content.Server._Mini.Objectives.Systems;
...
public sealed class ResearchDiskConditionSystem : EntitySystem
{
    ...
    private void OnAfterAssign(Entity<ResearchDiskConditionComponent> condition, ref ObjectiveAfterAssignEvent args)
    {
        ...
        _objectives.SetIcon(condition.Owner, new SpriteSpecifier.Texture(new("/Textures/_Mini/Objects/Specific/Research/data_disk.rsi/icon.png")), args.Objective);
    }
